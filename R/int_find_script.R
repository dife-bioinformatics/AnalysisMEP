...
#' @description This is an internal function which will find the correct path
#' for the scripts during project setup after installation.
#' @details This function adapts the code from the internal function
#' find_template from the `usethis::use_template` function.
#' @param script_name specifies which script is called.
#' @param package name of the package where the scripts are included ("mepr").
